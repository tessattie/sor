...
class DocumentsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'doc_path' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            'id' => 1,
            'customer_id' => 1,
            'doc_path' => 'Lorem ipsum dolor sit amet',
